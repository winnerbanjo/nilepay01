      ...
      <div className="w-full max-w-3xl space-y-8 animate-fade-in-up">
        ...
        <div className="text-center space-y-2">
          <h2 className="text-2xl sm:text-3xl font-black text-nile-darkgreen tracking-tight">
            Register your business for card payments
          </h2>
          <p className="text-sm text-nile-muted max-w-md mx-auto">
            Choose the profile that matches your business. We’ll use it to prepare compliance, create your merchant account after approval, and activate collections in the Nile app.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <button
            ...
            className="bg-white hover:bg-slate-50 border border-nile-border hover:border-nile-darkgreen p-8 rounded-3xl text-left shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between group h-80 focus:outline-none focus:ring-2 focus:ring-nile-softmint card-hover-effect"
          >
